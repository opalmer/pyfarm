...
#
# Created: Wed Jan  7 22:20:22 2009
...
class Ui_Proto2(object):
    def setupUi(self, Proto2):
        Proto2.setObjectName("Proto2")
        Proto2.resize(1004, 300)
        self.layoutWidget = QtGui.QWidget(Proto2)
        ...
        self.layoutWidget1 = QtGui.QWidget(Proto2)
        ...
        self.retranslateUi(Proto2)
        QtCore.QObject.connect(self.quitButton, QtCore.SIGNAL("clicked()"), Proto2.close)
        QtCore.QMetaObject.connectSlotsByName(Proto2)

    def retranslateUi(self, Proto2):
        Proto2.setWindowTitle(QtGui.QApplication.translate("Proto2", "PyFarm -- Prototype  2", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("Proto2", "Scene:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("Proto2", "Start Frame", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("Proto2", "End Frame", None, QtGui.QApplication.UnicodeUTF8))
        self.findNodesButton.setText(QtGui.QApplication.translate("Proto2", "Find Nodes", None, QtGui.QApplication.UnicodeUTF8))
        self.aboutButton.setText(QtGui.QApplication.translate("Proto2", "About", None, QtGui.QApplication.UnicodeUTF8))
        self.renderButton.setText(QtGui.QApplication.translate("Proto2", "Render", None, QtGui.QApplication.UnicodeUTF8))
        self.stopRender.setText(QtGui.QApplication.translate("Proto2", "Cancel Render", None, QtGui.QApplication.UnicodeUTF8))
        self.quitButton.setText(QtGui.QApplication.translate("Proto2", "Quit", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("Proto2", "Progress", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("Proto2", "Hosts:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("Proto2", "Output Console", None, QtGui.QApplication.UnicodeUTF8))
