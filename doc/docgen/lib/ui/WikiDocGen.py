...
# Form implementation generated from reading ui file 'doc/docgen/QtDesigner/WikiDocGen.ui'
#
...
class Ui_WikiDocGen(object):
    def setupUi(self, WikiDocGen):
        ...
        self.generateIndex = QtGui.QCheckBox(self.layoutWidget)
        self.generateIndex.setChecked(True)
        self.generateIndex.setObjectName("generateIndex")
        self.hboxlayout.addWidget(self.generateIndex)
    ...
    def retranslateUi(self, WikiDocGen):
        ...
        self.generateIndex.setText(QtGui.QApplication.translate("WikiDocGen", "Generate Index", None, QtGui.QApplication.UnicodeUTF8))
