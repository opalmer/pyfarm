...
'cs_posts' 					=> "posts",
'cs_members' 				=> "members",
'cs_active'  				=> "users online",
'q_topics'   				=> "Queued topics:",
'q_posts'    				=> "posts:",

// added in 2.0

'enter_search_words' 		=> "Enter words to search...",
...
'whoschatting_delay' 		=> "Updated every %s minutes",

'rd_hits'       			=> "Redirected Hits",
'oul_show_more' 			=> "Show detailed by:",
'oul_click' 				=> "Last Click",
'oul_name'  				=> "Member Name",

'qli_title'  				=> "Quick Log In",
'qli_name'   				=> "User Name",
'qli_go'     				=> "Go",
...
'welcome_back_text'  		=> "Welcome back; your last visit was",

'sm_today_posters'   		=> "Today's top 20 posters",
'sm_all_posters'     		=> "Overall top 20 posters",
...
'birthday_header'       	=> "Today's Birthdays",
...
'guests'					=>	"guests",
'posts'						=>	"posts",
'total_of'					=>	"has a total of",
'browser_user_list'			=>	"View Complete List",

'forum_leader'				=>	"Forum Led by: ",
...
'cat_name'					=>	"Forum",
'in'						=>	"In",
'registered_mems'			=>	"registered members",
'topics'					=>	"Topics",
...
'info'						=>	"Information",
'active_users'				=>	"user(s) active in the past %s minutes",
